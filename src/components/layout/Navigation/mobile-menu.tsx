...
export default function MobileMenu({
  ...
  return (
    <>
      ...
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm animate-backdrop z-[99998]"
        onClick={onClose}
      />

      {/* Slide-out menu */}
      <div className="fixed top-0 right-0 bottom-0 h-screen w-full max-w-sm bg-white shadow-xl animate-slide-in z-[99999] flex flex-col">
        {/* Header */}
        ...
        {/* Navigation Content - THIS IS THE KEY FIX */}
              ...
              <div className="space-y-1">
                {navigationItems.map((item) => (
                  ...
                  >
                    ...
                    {expandedItem === item.id && item.hero && (
